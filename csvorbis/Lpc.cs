...
namespace csvorbis 
{
	internal sealed class Lpc
	{
		...
		internal static float lpc_from_data(float[] data, float[] lpc, int n, int m)
		{
		...
		internal static float FAST_HYPOT(float a, float b)
		{
